...
ax[1].plot(f,np.imag(Qf_130_DB.Z_c))
ax[1].plot(f,np.imag(Qf_130_BA.Z_c) )
...
fig,ax = plt.subplots(2,1, figsize = (5,6.5))
ax[0].set_xticklabels([])
ax[0].plot(f,np.real(C_100_DB.Z_c) )
ax[0].plot(f,np.real(C_100_BA.Z_c) )
ax[0].set_ylabel(r'$Re[R/(\rho c)]$')
ax[1].plot(f,np.imag(C_100_DB.Z_c) )
ax[1].plot(f,np.imag(C_100_BA.Z_c) )
...
fig,ax = plt.subplots(2,1, figsize = (5,6.5))
fig.subplots_adjust(left = 0.15)
ax[0].plot(f,np.real(M_1_DB.Z) )
ax[0].plot(f,np.real(M_1_BA.Z) )
ax[0].plot(f,np.real(M_1_BA_tuned.Z) )
ax[0].scatter(m1_Re_Z[:,0],m1_Re_Z[:,-1],c = 'black')
ax[0].set_ylabel(r'$Re[Z/\rho c]$')
ax[1].plot(f,np.imag(M_1_DB.Z) )
ax[1].plot(f,np.imag(M_1_BA.Z) )
ax[1].plot(f,np.imag(M_1_BA_tuned.Z) )
