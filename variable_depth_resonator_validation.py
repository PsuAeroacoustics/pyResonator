...
'''
This is a validation of the model implemintation using data from:
    Galles, Matthew B., Michael G. Jones, and Douglas M. Nark. “An Initial Assessment of Variable Depth Liner Optimization for Ducted Proprotor Applications.” 28th AIAA/CEAS Aeroacoustics 2022 Conference, Southampton, UK, 2022. https://doi.org/10.2514/6.2022-2821.
